...
import 'package:supplier_multi_store_app/auth/forgot_password.dart';
...
class SupplierLogin extends StatefulWidget {
  ...
  @override
  State<SupplierLogin> createState() => SupplierLoginState();
}
  ...
  void logIn() async {
    ...
    if (_formkey.currentState!.validate()) {
      try {
        ...
        perf.setString('supplierid', FirebaseAuth.instance.currentUser!.uid);
