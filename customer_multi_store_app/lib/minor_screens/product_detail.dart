...
import 'package:customer_multi_store_app/minor_screens/full_screen_view.dart';
                      ...
                      onPressed: () {
                        if (widget.productList['product_instoke'] == 0) {
                          ...
                          context.read<Cart>().addItem(
                                Product(
                                  name: widget.productList['product_name'],
                                  price:
                                      widget.productList['product_discount'] !=
                                              0
                                          ? ((1 -
                                                  (widget.productList[
                                                          'product_discount'] /
                                  ...
                                  imagesUrl: imagesList.first,
                                  documentId: widget.productList['product_id'],
                                  supplierId: widget.productList['supplier_id'],
                                ),
                              );
                        }
